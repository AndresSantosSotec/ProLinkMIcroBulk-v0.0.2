    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="fs-3 fw-bold text-primary">
                <i class="fas fa-columns me-2"></i> Configuración de Columnas para Colocaciones
            </h1>
        ...
        <p class="text-muted">Aquí puedes gestionar las columnas para la tabla de Colocaciones.</p>
                    ...
                    <tbody>
                        @foreach ($allColumns as $index => $column)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('columnas.colocaciones.editar', $column['column_name']) }}"
        ...
        window.deleteColumn = function(columnName) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('{{ route('delete-column-colocaciones') }}', {
                            method: 'POST',
                            headers: {
