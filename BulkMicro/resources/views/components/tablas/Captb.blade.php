    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="fs-3 fw-bold text-primary">
                <i class="fas fa-columns me-2"></i> Configuración de Columnas para Captaciones
            </h1>
        ...
        <p class="text-muted">Aquí puedes gestionar las columnas para la tabla de Captaciones.</p>
                    ...
                    <tbody>
                        @foreach ($allColumns as $index => $column)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('columnas.captaciones.editar', $column['column_name']) }}"
